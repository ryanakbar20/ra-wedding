      ...
      <Animation>
        <div className="flex flex-1 flex-col space-y-4 ">
          ...
          >
            ...
            dalam beberapa event kami juga mengambil bagian dalam pekerjaan
            total produksi event, meliputi pengorganisasian sound system,
            lighting system, power supply, AC, dan alat pendukung event lainnya.
          </p>
          <ButtonWhatsapp />
        </div>
      </Animation>
